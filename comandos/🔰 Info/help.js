        ...
        if (args[0]) {
            ...
            if (comando) {
                let embed = new Discord.MessageEmbed()
                    ...
                    .setFooter({ text: `BOT de MaracaiboTM`, iconURL: `https://cdn.dribbble.com/users/1199444/screenshots/7155098/media/38eedcf258023ee7de0017801cbfc660.jpg?compress=1&resize=400x300` })
            ...
            .setColor(client.color)
            .setDescription(`Bot Multifuncional en Desarollo por \`! LuK#9692\``)
            ...
            .setFooter({ text: `Página 1 / ${categorias.length+1}\nBOT de MaracaiboTM`, iconURL: `https://images-ext-2.discordapp.net/external/G2O3wNQkWm957e5Qv3xUpceIQozUug5Z_dfyP9aIKYQ/%3Fsize%3D4096/https/cdn.discordapp.com/avatars/282942681980862474/c2136834f15c6f8633c19c72feeb2427.webp` })
