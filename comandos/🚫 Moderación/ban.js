...
module.exports = {
    ...
    desc: "Sirve para mandar a comer mierda a un trimardecio hijueputa",
    ...
    run: async (client, message, args, prefix) => {
        ...
        if (!usuario) return message.reply(`❌ **No se ha encontrado al comemierda que has querido banear!**`);
        ...
        if(usuario.id == message.guild.ownerId) return message.reply(`❌ **No puedes banear al DUEÑO del servidor maldito hijueputa!**`);
        ...
        if (message.guild.me.roles.highest.position > usuario.roles.highest.position) {
            ...
            if (message.member.roles.highest.position > usuario.roles.highest.position) {
                ...
                usuario.send({embeds: [
                    ...
                    .setTitle(`Te fuiste a comer mierda mardito __${message.guild.name}__`)
